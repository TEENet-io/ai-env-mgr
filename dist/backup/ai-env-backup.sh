...
# pg_dump inside the database container, gzip, upload with the console's
# credentials, delete the local copy. The dump never touches the bucket's
# command objects; it goes to _backup/ and is pruned after 30 days.
set -eu
